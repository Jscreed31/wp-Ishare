...
$motu_panels_sections = array(
	...
	'home_sections_repeater' => array(
		...
		'title' => esc_html__('Homepage Content Section','motu'),
		'sections' => array(
	...
	'theme_option_panel' => array(
		...
		'sections' => array(
			...
			array(
				'title' => esc_html__('Header Settings','motu'),
			...
			array(
				...
				'url'	=> esc_url( $base_url.'/wp-admin/customize.php?autofocus%5Bsection%5D=motu_pagination_section'),
                'icon'	=> 'dashicons-ellipsis',
            ),
			array(
				'title' => esc_html__('Article Meta Settings','motu'),
...
$rec_plugins = Motu_Getting_started::motu_recommended_plugins();
            ...
            <div class="about-wrapper-inner">
                <div class="about-header-left">
                    <h1 class="about-theme-title">
                        <a href="<?php echo esc_url( 'https://www.themeinwp.com/theme/motu' ); ?>">
                            <img src="<?php echo esc_url( get_template_directory_uri().'/assets/images/motu-logo.png' ); ?>" class="about-theme-logo">
                            <span class="theme-version"><?php echo esc_html( $theme_version ); ?></span>
                        </a>
                    </h1>
                </div>
                <div class="about-header-right">
                    <p><?php esc_html_e('Eye-catching, Lightweight, and Highly Customizable WordPress Theme','motu'); ?></p>
                </div>
            </div>
		</div>
	</div>
	    ...
	    <div class="about-wrapper">
            <div class="about-wrapper-inner">
                ...
                <div class="about-content-left">
                    ...
                    <?php
                    foreach( $motu_panels_sections as $panels ){ ?>
					...
					<div class="about-content-panel">
						...
						<h2 class="about-panel-title"><?php esc_html_e('Recommended Plugins','motu'); ?></h2>
						...
						<div class="about-panel-items about-panel-1-columns">
							...
							<?php foreach ($rec_plugins as $key => $plugin) {
	                            ...
	                            $plugin_status = Motu_Getting_started::motu_plugin_status($plugin['class'], $key, $plugin['PluginFile']); ?>

	                            <div id="<?php echo 'motu-' . esc_attr($key); ?>" class="about-items-wrap">
                ...
                <div class="about-content-right">
                    ...
                    <div class="about-content-panel">
                        <h2 class="about-panel-title"><span class="dashicons dashicons-sos"></span> <?php esc_html_e('Looking for help?','motu'); ?></h2>
                        <div class="about-content-info">
                            <p><?php esc_html_e('We have some resources available to help you in the right direction.','motu'); ?></p>
                            <ul>
                                <li>
                                    <a href="<?php echo esc_url( 'https://www.themeinwp.com/support/' ); ?>" target="_blank" rel="noopener"><?php esc_html_e('Create a Ticket','motu'); ?> &#187;</a>
                                </li>
                                <li>
                                    <a href="<?php echo esc_url( 'https://www.themeinwp.com/knowledgebase/' ); ?>" target="_blank" rel="noopener"><?php esc_html_e('Knowledge Base','motu'); ?> &#187;</a>
                                </li>
                                <li>
                                    <a href="<?php echo esc_url( 'https://docs.themeinwp.com/docs/motu' ); ?>" target="_blank" rel="noopener"><?php esc_html_e('Theme Documentation','motu'); ?> &#187;</a>
                                </li>
                            </ul>
                            <p><?php esc_html_e('Behind every single customer support question stands a real person ready to fix the problem in real-time and guide you through.','motu'); ?></p>
                        </div>
                    </div>
            ...
            <div class="about-wrapper-inner">
                <div class="about-content-full">
                    <div class="about-wrapper-footer">
                        <h2 class="about-panel-title"><?php printf( __( 'Unlock all the Features with %1$s Pro', 'motu' ), esc_html( $theme_name ) ); ?></h2>
                        <div class="about-footer-leftside">
                            <ul>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('Color Options','motu'); ?></li>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('800+ Font Families','motu'); ?></li>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('More Custom Widgets','motu'); ?></li>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('More Customizer controls','motu'); ?></li>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('More page/post meta options','motu'); ?></li>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('Webmaster Tools','motu'); ?></li>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('Remove Footer Attribution (copyright)','motu'); ?></li>
                                <li><span class="dashicons dashicons-yes"></span><?php esc_html_e('VIP priority Support','motu'); ?></li>
                                <li><span class="dashicons dashicons-plus"></span><?php esc_html_e('much more stuff...','motu'); ?></li>
                            </ul>
                        </div>
                        <div class="about-footer-rightside">
                            <div class="about-footer-upgrade">
                                <h3 class="footer-upgrade-title">
                                    <?php esc_html_e('Upgrade to Pro','motu'); ?>
                                </h3>
                                <div class="footer-upgrade-price">
                                    <sup><?php esc_html_e('$','motu'); ?></sup>
                                    <span><?php esc_html_e('59','motu'); ?></span>
                                </div>
