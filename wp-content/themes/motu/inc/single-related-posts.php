...
* @package Motu
*/
if( !function_exists('motu_related_posts') ):

	// Single Posts Related Posts.
	function motu_related_posts(){
        ...
        if( $motu_header_trending_page != $current_id && $motu_header_popular_page != $current_id && is_single() && 'post' === get_post_type() ){
    		...
    		$ed_related_post = absint( get_theme_mod( 'ed_related_post',$motu_default['ed_related_post'] ) );

    		if( $ed_related_post && $related_posts_query->have_posts() ): ?>

    			<div class="theme-block related-posts-area">

    	        	<?php $related_post_title = esc_html( get_theme_mod( 'related_post_title',$motu_default['related_post_title'] ) ); 
...
add_action( 'motu_navigation_action','motu_related_posts',20 );