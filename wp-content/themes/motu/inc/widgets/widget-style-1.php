 ...
 * @package Motu
 */
if (!function_exists('motu_widgets_style_1')) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function motu_widgets_style_1()
    {
        register_widget('Motu_widget_Style_1');
    }
endif;
add_action('widgets_init', 'motu_widgets_style_1');
// Article Widget Layout 1
if (!class_exists('Motu_widget_Style_1')) :
    /**
     * Article Widget Layout 1
     *
     * @since 1.0.0
     */
    class Motu_widget_Style_1 extends Motu_Widget_Base
    {
        /**
        ...
        function __construct()
        {
            ...
            $fields = array(
                ...
                'hide_feature_image' => array(
                    'label' => esc_html__('Featured Image:', 'motu'),
                    'default' => 'style-1',
                    'type' => 'radio',
                    'css' => 'display:block;',
                    'options' => array(
                        'style-1' => esc_html__('Show Featured Image', 'motu'),
                        'style-2' => esc_html__('Hide Featured Image', 'motu'),
                        'style-3' => esc_html__('Hide Sub Post Featured Post', 'motu'),
                    ),
                ),
                'post_description' => array(
                    ...
                    'css' => 'display:block;',
                    'options' => array(
                        'post-1' => esc_html__('Show Description', 'motu'),
                        'post-2' => esc_html__('Hide Description', 'motu'),
                        'post-3' => esc_html__('Hide Sub Post Description', 'motu'),
                    ),
                ),
            );
            parent::__construct('motu-widget-style-1', esc_html__('Motu: Post Widget 1', 'motu'), $opts, array(), $fields);
        }
