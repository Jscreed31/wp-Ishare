...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    class Motu_Separator extends WP_Customize_Control {

        public $type = 'motu-separator';
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Radio Image Custom Control Class.
    class Motu_Custom_Radio_Image_Control extends WP_Customize_Control {

        public $type = 'motu-radio-image';
        ...
        public function render_content() {
            ...
            <div id="input_<?php echo esc_attr($this->id); ?>" class="image motu-radio-image-buttenset">
 ...
 * @access public
 */
class Motu_Customize_Section_Upsell extends WP_Customize_Section {
...
*/
class Motu_Repeater_Controler extends WP_Customize_Control {
    /**
     * The control type.
     *
     * @access public
    ...
    */
    ...
    public $motu_box_label = '';

    public $motu_box_add_control = '';

    public $motu_box_add_button = '';
    ...
    public function __construct( $manager, $id, $args = array(), $fields = array() ) {
        $this->fields = $fields;
        $this->motu_box_label = $args['motu_box_label'] ;
        $this->motu_box_add_control = $args['motu_box_add_control'];
        $this->motu_box_add_button = $args['motu_box_add_button'];
    ...
    public function render_content() {
        ...
        <ul class="motu-repeater-field-control-wrap">
            <?php
            $this->motu_get_fields();
            ?>
        </ul>
        <input type="hidden" <?php esc_attr( $this->link() ); ?> class="motu-repeater-collector" value="<?php echo esc_attr( $this->value() ); ?>" />
        <?php

        if( isset( $this->motu_box_add_button ) && $this->motu_box_add_button ){ ?>
            
            <button type="button" class="button motu-add-control-field"><?php echo esc_html( $this->motu_box_add_control ); ?></button>
        <?php
        }
    ...
    private function motu_get_fields(){
            ...
            foreach($values as $value){ ?>
                ...
                <div class="motu-repeater-fields">
                    ...
                    foreach ($fields as $key => $field) {
                        ...
                        <div class="motu-fields motu-type-<?php echo esc_attr($field['type']).' '.esc_attr( $class ); ?>">
                            ...
                            switch ($field['type']) {
                                ...
                                case 'selector_color':
                                    ...
                                    $options = $field['options'];
                                    echo '<div class="motu-type-radio">';
                                ...
                                case 'upload':
                                        ...
                                        esc_html_e('No image selected', 'motu');
                                        echo '</div>';
                                        echo '<div class="thumbnail thumbnail-image">';
                                        echo $image;
                                        echo '</div>';
                                        echo '<div class="actions clearfix">';
                                        echo '<button type="button" class="button twp-img-delete-button align-left">'.esc_html__('Remove', 'motu').'</button>';
                                        echo '<button type="button" class="button twp-img-upload-button alignright">'.esc_html__('Select Image', 'motu').'</button>';
                    ...
                    <div class="clearfix motu-repeater-footer">
                        <div class="alignright">
                        <?php if( isset( $this->motu_box_add_button ) && $this->motu_box_add_button ){ ?>
                            <a class="motu-repeater-field-remove" href="#remove"><?php esc_html_e('Delete', 'motu') ?>|</a> 
                        <?php } ?>
                        <a class="motu-repeater-field-close" href="#close"><?php esc_html_e('Close', 'motu') ?></a>
                        </div>
                    </div>
                </div>
                </li>
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Motu_Info_Notiece_Control extends WP_Customize_Control {
            ...
            <span class="customize-control-title">
                ...
                <div class="twp-info-icon">
                    <div class="icon-notice-wrap">
                        <span class="dashicons dashicons-move twp-filter-icon"></span>
                        <p><?php esc_html_e( 'Click hold and drag to re-order.', 'motu' ); ?></p>
                    </div>
                    <div class="icon-notice-wrap">
                        <span class="dashicons dashicons-arrow-down twp-filter-icon"></span>
                        <p><?php esc_html_e( 'Click to expand settings.', 'motu' ); ?></p>
                    </div>
                </div>
            </span>
...
if ( class_exists( 'WP_Customize_Control' ) ) {
    ...
    // Repeator Info
    class Motu_Premium_Notiece_Control extends WP_Customize_Control {
            ...
            <span class="customize-control-title">
                <div class="theme-info-icon">
                    <div class="icon-notice-wrap">
                        ...
                        <span><?php echo esc_html__('More ','motu'). esc_html( $this->label ). esc_html__(' Available on Premium Version.', 'motu' ); ?></span>
                    </div>
                </div>
            </span>
...
if ( ! function_exists( 'motu_sanitize_number_range' ) ) :
     ...
     */
    function motu_sanitize_number_range( $input, $setting ) {
