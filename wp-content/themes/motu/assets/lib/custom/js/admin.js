(function ($) {
    ...
    var ajaxurl = motu_admin.ajax_url;
    var newsWrapNonce = motu_admin.ajax_nonce;
    var custom_theme_file_frame;

    // Category Color
    $('#motu-cat-color').wpColorPicker();
    ...
    $('.twp-img-upload-button').click( function(){
        ...
        frame = wp.media({
            title: motu_admin.upload_image,
            button: {
            text: motu_admin.use_image
            },
    ...
    $('.twp-custom-setup').click(function(){
        ...
        var data = {
            'action': 'motu_notice_dismiss',
            '_wpnonce': newsWrapNonce,
        };
 
        $.post(ajaxurl, data, function( response ) {

            $('.twp-motu-notice').hide();
    ...
    $('.twp-install-active').click(function(){
        ...
        $(this).closest('.twp-motu-notice').addClass('twp-installing');

        var data = {
            'action': 'motu_install_plugins',
            '_wpnonce': newsWrapNonce,
        };
    ...
    $('.theme-recommended-plugin .recommended-plugin-status').click(function(){
        ...
        $.post(ajaxurl, data, function( response ) {
            ...
            var active = motu_admin.active
            var deactivate = motu_admin.deactivate
