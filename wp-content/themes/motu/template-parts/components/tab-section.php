 ...
 * @package Motu
 */
if (!function_exists('motu_banner_block_1_section')):
    function motu_banner_block_1_section($motu_home_section,$repeat_times)
    {
        $section_post_slide_cat = esc_html(isset($motu_home_section->section_post_slide_cat) ? $motu_home_section->section_post_slide_cat : '');
        
        $section_category_1 = esc_html(isset($motu_home_section->section_category_1) ? $motu_home_section->section_category_1 : '');
        $section_category_2 = esc_html(isset($motu_home_section->section_category_2) ? $motu_home_section->section_category_2 : '');
        $section_category_3 = esc_html(isset($motu_home_section->section_category_3) ? $motu_home_section->section_category_3 : '');
        $section_category_4 = esc_html(isset($motu_home_section->section_category_4) ? $motu_home_section->section_category_4 : '');

        $ed_tab = esc_html(isset($motu_home_section->ed_tab) ? $motu_home_section->ed_tab : '');
        $ed_flip_column = esc_html(isset($motu_home_section->ed_flip_column) ? $motu_home_section->ed_flip_column : '');
        $home_section_title_1 = esc_html(isset($motu_home_section->home_section_title_1) ? $motu_home_section->home_section_title_1 : '');
        $home_section_title_2 = esc_html(isset($motu_home_section->home_section_title_2) ? $motu_home_section->home_section_title_2 : '');
        ...
        if (empty($home_section_title_2)) {
            ...
            <div class="wrapper-inner wrapper-inner-small">
                <?php if ($banner_post_slide_query->have_posts()): ?>
                    <div class="column column-7 column-sm-12 column-xs-12 mb-md-20 <?php if ($ed_flip_column != 'yes') { ?>column-order-1<?php } else { ?>column-order-2<?php } ?>">
                ...
                <div class="column column-5 column-sm-12 column-xs-12 <?php if ($ed_flip_column != 'yes') { ?>column-order-2<?php } else { ?>column-order-1<?php } ?>">
                        ...
                        <header class="block-title-wrapper">
                            ...
                            if ($ed_tab == 'yes' && ($section_category_1 || $section_category_2 || $section_category_3 || $section_category_4)) { ?>
                                ...
                                <div class="theme-dropdown clear">
                                    ...
                                    <span class="tab-selected-category"><?php esc_html_e('All', 'motu'); ?></span>
                                    <span class="tab-selected-icon"><?php motu_theme_svg('chevron-down'); ?></span>
                                    </button>

                                    <ul class="tab-posts hide-no-js">

                                    <li><a cat-data="all" class="active-tab" href="javascript:void(0)"><?php esc_html_e('All', 'motu'); ?></a></li>
