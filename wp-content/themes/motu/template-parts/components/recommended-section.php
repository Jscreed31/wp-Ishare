 ...
 * @package Motu
 */
if (!function_exists('motu_you_may_like_block_section')):
    function motu_you_may_like_block_section($motu_home_section,$repeat_times){
                    ...
                    <?php if( $you_may_like_post_query ->have_posts() ){
                        ...
                        while( $you_may_like_post_query ->have_posts() ){
                            ...
                            <div class="column column-4 column-sm-6 column-xxs-12">
                                <article id="theme-post-<?php the_ID(); ?>" <?php post_class( 'news-article news-article-panel theme-image-overlay' ); ?>>
