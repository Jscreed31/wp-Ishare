...
if ( ! class_exists( 'Refrigerator_Repair_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Refrigerator_Repair_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Refrigerator_Repair_WPTT_WebFont_Loader( $url );
