...
/**
 *
 * @package Professional Refrigerator Repair
 */
if (!function_exists('refrigerator_repair_font_awesome_icon_array')) {

    function refrigerator_repair_font_awesome_icon_array() {
