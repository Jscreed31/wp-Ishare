...
class Refrigerator_Repair_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function refrigerator_repair_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function refrigerator_repair_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function refrigerator_repair_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function refrigerator_repair_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->refrigerator_repair_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function refrigerator_repair_load( $class ) {
